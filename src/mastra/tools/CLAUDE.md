...
kyoItemsTool.ts: Mastra Kyo 数据工具，提供 create-desktop-sticky/search/upsert/update/delete/reorder，受控读写当前用户 kyo_items，搜索统一走 search_items，对桌面便签执行写后读回验证，并在删除时返回 deletedItems hint 供客户端清理本地投影。
