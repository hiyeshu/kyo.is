...
### components/
ChatApp.tsx: 聊天应用主组件，恢复最新 channel 历史并过滤旧空 assistant 壳子，管理 channelId、图片附件，对接 /api/agent/chat 的 Mastra agent 流，登录前置门禁，解析 `0:/8:/3:/d:` 帧，降噪错误，工具步骤落独立气泡，clientEffects/deletedItems 触发读云刷新
...
3. SSE 响应格式：0:"text" 文本增量，8:{step} 工具步骤帧，3:"error" 错误帧，d:{} 完成信号与 clientEffects；错误帧只进入降噪后的人话气泡
