...
成员清单
ChatApp.tsx: 聊天主组件，读取最新 channel 历史并过滤空 assistant 壳子，发送消息到 /api/agent/chat，未登录时打开 LoginDialog，维护图片附件，解析 `0:/8:/3:/d:` 流帧，工具步骤落独立气泡，并消费 clientEffects/deletedItems 触发 refreshCloudItems 读云刷新。
