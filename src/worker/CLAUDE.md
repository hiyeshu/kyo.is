...
routes.ts: Worker API 路由，处理 agent chat、channel 列表、channel messages。
compatRoutes.ts: Worker 兼容 API 路由，处理 scrape、bookmark-preview、audio-transcribe、save/search/sync/items，并统一前端 camelCase 与数据库 snake_case 字段。
